...
data.addItem(
	...
	[addStat(Stat.ATTACK_SIZE, 39), addStat(Stat.INTENSITY, 27)],
	2
);
...
data.addItem(
	...
	[addStat(Stat.DEFENSE, 189), addStat(Stat.ATTACK_SPEED, 24)],
	2
);
...
data.addItem(
	...
	[addStat(Stat.DEFENSE, 96), addStat(Stat.ATTACK_SPEED, 36)],
	2
);
...
data.addItem(
	...
	[addStat(Stat.DEFENSE, 189), addStat(Stat.INTENSITY, 32)],
	2
);
...
data.addItem(
	...
	[addStat(Stat.POWER, 21), addStat(Stat.ATTACK_SPEED, 24)],
	2
);
...
data.addItem(
	...
	[addStat(Stat.POWER, 21), addStat(Stat.AGILITY, 18), addStat(Stat.ATTACK_SIZE, 18)],
	2
);
...
data.addItem(
	...
	[addStat(Stat.POWER, 21), addStat(Stat.AGILITY, 24)],
	2
);
...
data.addItem(
	...
	[addStat(Stat.AGILITY, 18), addStat(Stat.ATTACK_SPEED, 30)],
	2
);
...
data.addItem(
	...
	[addStat(Stat.ATTACK_SPEED, 36), addStat(Stat.WARDING, 1)],
	3
);

data.addItem('Titanium Armor', 0, '', 'gear/chestplates/titanium_armor.webp', [], 0);
...
data.addItem(
	...
	[addStat(Stat.POWER, 37), addStat(Stat.DEFENSE, 97), addStat(Stat.DRAWBACK, 1)],
	2
);
